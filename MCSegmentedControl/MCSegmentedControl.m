...
//
//  Modified by Helen Yang 13/08/2012
//
...
- (void)_initialize
{
    ...
    self.tintColor = [UIColor colorWithRed:.0 green:.6 blue:.0 alpha:1.0];
	...
	self.unSelectedItemBackgroundGradientColors = [NSArray arrayWithObjects:
												   [UIColor colorWithRed:170/255.0 green:170/255.0 blue:170/255.0 alpha:0.5],
												   [UIColor colorWithRed:70/255.0 green:70/255.0 blue:70/255.0 alpha:0.5],
												   nil];
...
- (void)drawRect:(CGRect)rect
{
	...
	CGContextMoveToPoint(c, minx - .25, midy - .25);
	CGContextAddArcToPoint(c, minx - .25, miny - .25, midx - .25, miny - .25, _cornerRadius);
	CGContextAddArcToPoint(c, maxx - .25, miny - .25, maxx - .25, midy - .25, _cornerRadius);
	CGContextAddArcToPoint(c, maxx - .25, maxy - .25, midx - .25, maxy - .25, _cornerRadius);
	CGContextAddArcToPoint(c, minx - .25, maxy - .25, minx - .25, midy - .25, _cornerRadius);
